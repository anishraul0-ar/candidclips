...
function Hero() {
  const videoPlaceholders = [
    { bg: "#E8DDD3", label: "Skincare Ad" },
    { bg: "#D4E4D9", label: "Fitness Ad" },
    { bg: "#DDD8E8", label: "Food Ad" },
    { bg: "#E8D4D4", label: "Tech Ad" },
    { bg: "#D8E0E8", label: "Fashion Ad" },
  ];
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
        ...
        <div className="flex-1 flex gap-3 items-end justify-center">
          {videoPlaceholders.map((v, i) => (
            <div
              key={i}
              className={`drift-${i + 1} relative rounded-sm border-2 border-ink overflow-hidden`}
              style={{
                width: i === 2 ? 130 : 100,
                height: i === 2 ? 230 : 190,
            ...
            >
              ...
              <div
                className="absolute bottom-2 left-2 bg-ink/80 text-paper text-[9px] px-1.5 py-0.5 rounded-sm flex items-center gap-1"
                style={{
                  fontFamily: "var(--font-mono, 'DM Mono', monospace)",
                }}
              >
...
function Proof() {
  const videos = Array.from({ length: 6 }, (_, i) => ({
    bg: ["#E8DDD3", "#D4E4D9", "#DDD8E8", "#E8D4D4", "#D8E0E8", "#E0D8D0"][i],
    label: ["Skincare", "Fitness", "Coffee", "Tech", "Fashion", "Beauty"][i],
  }));
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-14 h-14 rounded-full bg-ink/10 flex items-center justify-center">
                  <div className="w-0 h-0 border-t-[8px] border-b-[8px] border-l-[14px] border-transparent border-l-ink/30 ml-1" />
                </div>
              </div>
              <div
                className="absolute top-3 left-3 bg-ink/80 text-paper text-[10px] px-2 py-1 rounded-sm flex items-center gap-1"
                style={{
                  fontFamily: "var(--font-mono, 'DM Mono', monospace)",
                }}
              >
              ...
              <div
                className="absolute bottom-3 left-3 text-ink/60 text-xs font-medium"
                style={{
                  fontFamily: "var(--font-mono, 'DM Mono', monospace)",
                }}
              >
